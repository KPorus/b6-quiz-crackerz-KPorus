      ...
      <div className='container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0'>
        <div className='lg:w-1/3'>
          <Link className='flex justify-center space-x-3 lg:justify-start'>
            ...
            <img src="https://img.icons8.com/external-smashingstocks-circular-smashing-stocks/65/000000/external-quiz-education-smashingstocks-circular-smashing-stocks.png"/>
            </div>
